...
The main idea behind this design is to implement a node with variable width and height. The concept behind it is to augment the workflow view with observability features. Allowing users to have more details available to them at a glance without having to inspect the nodes.
